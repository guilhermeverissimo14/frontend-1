...
@Component({
  selector: 'app-agente-endemias-adm-nacional-view',
  templateUrl: './agente-endemias-adm-nacional-view.component.html',
  styleUrls: ['./agente-endemias-adm-nacional-view.component.css']
})
export class AgenteEndemiasAdmNacionalViewComponent extends OnDestroyMixin implements OnInit {
  ...
  getDocumentoById(documentoId: number) {
    ...
    this.documentoService.getById(documentoId)
      ...
      .subscribe(
        ...
        (e) => {
          this.loading = false;
          this.router.navigate(['/agentes-endemias-adm-nacional']);
        }
      );
  }
