...
@Component({
  selector: 'app-documento-adm-estadual-view',
  templateUrl: './documento-adm-estadual-view.component.html',
  styleUrls: ['./documento-adm-estadual-view.component.css']
})
export class DocumentoAdmEstadualViewComponent extends OnDestroyMixin implements OnInit {
