...
@Component({
  selector: 'app-ubs-municipal-view',
  templateUrl: './ubs-municipal-view.component.html',
  styleUrls: ['./ubs-municipal-view.component.css']
})
export class UbsMunicipalViewComponent extends OnDestroyMixin implements OnInit {
